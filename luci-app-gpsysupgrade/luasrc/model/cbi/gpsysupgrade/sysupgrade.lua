...
function to_check()
    ...
    if board_name == "x86_64" then
    	...
    	if fs.access("/sys/firmware/efi") then
    		download_url = "https://github.com/qqxu223/OpenWrt_x86/releases/latest/download/" .. "MeowWrt-" .. remote_version .. "-x86-64-generic-squashfs-combined-efi.img.gz"
    	else
    		download_url = "https://github.com/qqxu223/OpenWrt_x86/releases/latest/download/" .. "MeowWrt-" .. remote_version .. "-x86-64-generic-squashfs-combined.img.gz"
    		md5 = ""
    	end
